...
const Products = () => {
  ...
  return (
    <section className="full w-full px-16 flex flex-col items-center">
      ...
      <div className="flex flex-col h-full space-y-14 mt-9">
        ...
        <div className="card bg-slate-50 h-100 w-100  shadow-md border rounded flex flex-col items-center space-y-6">
          ...
          <div className="font-work text-lg text-center">
            Mint and release your Music NFTs on our Launchpad and be entitled to
            free advertising on our homepage.
          </div>
          <div className="p-3 w-40 h-12 text-2xl font-bold font-work border-3 border-gray-300 align-middle flex items-center justify-center">
            In Progress
          </div>
        ...
        <div className="card bg-slate-50 h-100 w-100  shadow-md border rounded flex flex-col items-center space-y-6">
          <div className="font-russo text-center text-2xl mt-5">Track Yard</div>
          <div className="font-work text-lg text-center">
      ...
      <div className="mt-40 w-full h-80"></div>
    </section>
  );
};
